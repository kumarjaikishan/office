...
const menu = [
  {
    ...
    items: [
      ...
      { menu: "Attend Report", link: '/dashboard/attandence_Report', icon: <TbReportAnalytics />, roles: ['developer'] },
      { menu: "Payroll", link: '/dashboard/payroll', icon: <TbReportAnalytics />, roles: ['developer'] },
