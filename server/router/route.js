...
router.route("/entries/:id").get(authmiddlewre, authorizeRoles('superadmin','admin', 'manager'), checkPermission("ledgerentry", 1), ledger.Entries);
...
router.route("/ledgerentry").post(authmiddlewre, authorizeRoles('superadmin','admin', 'manager'), checkPermission("ledgerentry", 2), ledger.createEntry)

router.route("/ledgerentry/:id")
  .put(authmiddlewre, authorizeRoles('superadmin','admin', 'manager'), checkPermission("ledgerentry", 3), ledger.updateEntry)
  .delete(authmiddlewre, authorizeRoles('superadmin','admin', 'manager'), checkPermission("ledgerentry", 4), ledger.deleteEntry);
